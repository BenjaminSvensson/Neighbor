...
namespace Neighbor.Main.Features.Environment
{
    ...
    public sealed class AtmosphereFlickerLight : MonoBehaviour
    {
        ...
        [SerializeField, Min(1f)] private float maximumMemoryFlickerHoldMultiplier = 1.45f;
        ...
        [SerializeField, Range(0f, 1f)] private float resolvedInvestigationFlickerPressure = 0.08f;
        ...
        private void HandleStealthLoopChanged(PlayerFeedbackEvents.StealthLoopFeedback feedback)
        {
            ...
            {
                SettleStealthPressure(pressure, dangerFlickerHoldDuration);
                return;
            }

            RaiseStealthPressure(pressure, dangerFlickerHoldDuration);
        }
        ...
        private void HandleNeighborMemoryChanged(PlayerFeedbackEvents.NeighborMemoryFeedback feedback)
        {
            ...
            RaiseStealthPressure(GetMemoryPressure(feedback), GetMemoryFlickerHoldDuration(feedback));
        }
        ...
        private void HandleNeighborInvestigationChanged(PlayerFeedbackEvents.NeighborInvestigationFeedback feedback)
        {
            ...
            if (pressure > 0f)
            {
                ...
                {
                    SettleStealthPressure(pressure, investigationFlickerHoldDuration);
                    return;
                }

                RaiseStealthPressure(pressure, investigationFlickerHoldDuration);
            }
        }
        ...
        private float GetMemoryFlickerHoldDuration(PlayerFeedbackEvents.NeighborMemoryFeedback feedback)
        {
            ...
            return memoryFlickerHoldDuration * Mathf.Lerp(1f, maximumMemoryFlickerHoldMultiplier, commitment);
        }
        ...
        private float GetInvestigationPressure(PlayerFeedbackEvents.NeighborInvestigationFeedback feedback)
        {
            ...
            return feedback.Kind switch
            {
                ...
                PlayerFeedbackEvents.NeighborInvestigationFeedbackKind.Returning =>
                    resolvedInvestigationFlickerPressure,
